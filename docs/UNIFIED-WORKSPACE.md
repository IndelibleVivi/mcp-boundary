...
7. Archive the former repositories only through a separate deliberate owner action. Completed on 2026-09-25 with final `main` heads Guide `c913c16` and Lab `315eac0`.
