...
- all four English/Chinese homepage and engineering-library routes;
- fixed Offset + Porcelain identity, including hostile legacy query parameters;
- five workflow tabs, the before/after teaching specimen, keyboard behavior, and whitelisted query deep links;
- library surface filters, bilingual index search, empty/reset states, and query-preserving language links;
- clipboard success plus clipboard-denied fallback with focus restoration;
- mobile navigation and responsive widths from 320 to 1440 pixels with no document overflow;
